...
@section('title', 'Thêm sản phẩm - Gundam Shop')
    ...
    <div class="flex-1 ml-0 lg:ml-64">
        ...
        <header class="bg-bg-secondary border-b border-border px-6 py-4 sticky top-0 z-40">
            <div class="flex items-center gap-4">
                ...
                <h2 class="text-white font-semibold text-lg">Thêm sản phẩm mới</h2>
            </div>
        </header>
                ...
                <div class="grid lg:grid-cols-3 gap-6">
                    ...
                    <div class="lg:col-span-1 space-y-6">
                        ...
                        <div class="bg-bg-secondary border border-border rounded-xl p-6">
                            ...
                            <div>
                                <label for="image-upload" class="block text-text-secondary text-sm mb-2">Ảnh sản phẩm <span class="text-accent-red" aria-hidden="true">*</span></label>
                                <div class="border-2 border-dashed border-border rounded-xl p-4 text-center hover:border-accent-blue/50 transition-colors">
                                    ...
                                    <label for="image-upload" class="cursor-pointer">
                                        ...
                                        <p class="text-text-secondary text-sm">Chọn ảnh</p>
                                    </label>
                                </div>
